...
const HomeIntro = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32" style={{ backgroundColor: colors.paleGreen }}>
            <h1 className = "mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slante-900 sm:text-7xl">
